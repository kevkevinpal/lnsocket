var Module = (() => {
  ...
  return function(Module) {
    ...
    var _lnsocket_make_default_initmsg = (Module[
      "_lnsocket_make_default_initmsg"
    ] = function() {
      return (_lnsocket_make_default_initmsg = Module[
        "_lnsocket_make_default_initmsg"
      ] = Module["asm"]["n"]).apply(null, arguments);
    });
    var _lnsocket_encrypt = (Module["_lnsocket_encrypt"] = function() {
      return (_lnsocket_encrypt = Module["_lnsocket_encrypt"] =
        Module["asm"]["o"]).apply(null, arguments);
    });
    var _lnsocket_decrypt = (Module["_lnsocket_decrypt"] = function() {
      return (_lnsocket_decrypt = Module["_lnsocket_decrypt"] =
        Module["asm"]["p"]).apply(null, arguments);
    });
    var _lnsocket_decrypt_header = (Module[
      "_lnsocket_decrypt_header"
    ] = function() {
      return (_lnsocket_decrypt_header = Module["_lnsocket_decrypt_header"] =
        Module["asm"]["q"]).apply(null, arguments);
    });
    var _lnsocket_make_ping_msg = (Module[
      "_lnsocket_make_ping_msg"
    ] = function() {
      return (_lnsocket_make_ping_msg = Module["_lnsocket_make_ping_msg"] =
        Module["asm"]["r"]).apply(null, arguments);
    });
    var _lnsocket_msgbuf = (Module["_lnsocket_msgbuf"] = function() {
      return (_lnsocket_msgbuf = Module["_lnsocket_msgbuf"] =
        Module["asm"]["s"]).apply(null, arguments);
    });
    var _lnsocket_create = (Module["_lnsocket_create"] = function() {
      return (_lnsocket_create = Module["_lnsocket_create"] =
        Module["asm"]["t"]).apply(null, arguments);
    });
    var _lnsocket_destroy = (Module["_lnsocket_destroy"] = function() {
      return (_lnsocket_destroy = Module["_lnsocket_destroy"] =
        Module["asm"]["u"]).apply(null, arguments);
    });
    var _lnsocket_secp = (Module["_lnsocket_secp"] = function() {
      return (_lnsocket_secp = Module["_lnsocket_secp"] =
        Module["asm"]["v"]).apply(null, arguments);
    });
    var _lnsocket_genkey = (Module["_lnsocket_genkey"] = function() {
      return (_lnsocket_genkey = Module["_lnsocket_genkey"] =
        Module["asm"]["w"]).apply(null, arguments);
    });
    var _lnsocket_print_errors = (Module[
      "_lnsocket_print_errors"
    ] = function() {
      return (_lnsocket_print_errors = Module["_lnsocket_print_errors"] =
        Module["asm"]["x"]).apply(null, arguments);
    });
    var _lnsocket_act_two = (Module["_lnsocket_act_two"] = function() {
      return (_lnsocket_act_two = Module["_lnsocket_act_two"] =
        Module["asm"]["y"]).apply(null, arguments);
    });
    var _commando_make_rpc_msg = (Module[
      "_commando_make_rpc_msg"
    ] = function() {
      return (_commando_make_rpc_msg = Module["_commando_make_rpc_msg"] =
        Module["asm"]["z"]).apply(null, arguments);
    });
    var _lnsocket_act_one = (Module["_lnsocket_act_one"] = function() {
      return (_lnsocket_act_one = Module["_lnsocket_act_one"] =
        Module["asm"]["A"]).apply(null, arguments);
    });
    var stackSave = (Module["stackSave"] = function() {
      return (stackSave = Module["stackSave"] = Module["asm"]["B"]).apply(
        null,
        arguments
      );
    });
    var stackRestore = (Module["stackRestore"] = function() {
      return (stackRestore = Module["stackRestore"] = Module["asm"]["C"]).apply(
        null,
        arguments
      );
    });
...
async function lnsocket_init() {
  ...
  function SocketImpl(host) {
    ...
    if (socket.onmessage) throw new Error("socket already has onmessage?");
    ...
    if (socket.send) throw new Error("socket already has send?");
  ...
  const lnsocket_encrypt = module.cwrap("lnsocket_encrypt", "number", [
    "int",
    "array",
    "int",
    "int",
  ]);
  const lnsocket_decrypt = module.cwrap("lnsocket_decrypt", "number", [
    "int",
    "array",
    "int",
  ]);
  const lnsocket_decrypt_header = module.cwrap(
    "lnsocket_decrypt_header",
    "number",
    ["number", "array"]
  );
  const lnsocket_msgbuf = module.cwrap("lnsocket_msgbuf", "number", ["int"]);
  const lnsocket_act_one = module.cwrap("lnsocket_act_one", "number", [
    "number",
    "string",
  ]);
  const lnsocket_act_two = module.cwrap("lnsocket_act_two", "number", [
    "number",
    "array",
  ]);
  const lnsocket_print_errors = module.cwrap("lnsocket_print_errors", "int");
  const lnsocket_genkey = module.cwrap("lnsocket_genkey", "int");
  const lnsocket_make_default_initmsg = module.cwrap(
    "lnsocket_make_default_initmsg",
    "int",
    ["int", "int"]
  );
  const lnsocket_make_ping_msg = module.cwrap("lnsocket_make_ping_msg", "int", [
    "int",
    "int",
    "int",
    "int",
  ]);
  const commando_make_rpc_msg = module.cwrap("commando_make_rpc_msg", "int", [
    "string",
    "string",
    "string",
    "number",
  ...
  function concat_u8_arrays(arrays) {
    ...
    let totalLength = arrays.reduce(
      (acc, value) => acc + (value.length || value.byteLength),
      0
    );
  ...
  function LNSocket(opts) {
    if (!(this instanceof LNSocket)) return new LNSocket(opts);
  ...
  LNSocket.prototype.connect = async function lnsocket_connect(node_id, host) {
    ...
    if (act2.length != ACT_TWO_SIZE) {
      throw new Error(
        `expected act2 to be ${ACT_TWO_SIZE} long, got ${act2.length}`
      );
    }
  ...
  LNSocket.prototype.connect_and_init = async function _connect_and_init(
    node_id,
    host
  ) {
  ...
  LNSocket.prototype.read_all = async function read_all(n) {
    let count = 0;
    let chunks = [];
    if (!this.connected) throw new Error("read_all: not connected");
    while (true) {
  ...
  LNSocket.prototype.read_header = async function read_header() {
    ...
    if (header.length != 18) throw new Error("Failed to read header");
  ...
  LNSocket.prototype.make_commando_msg = function _lnsocket_make_commando_msg(
    opts
  ) {
    const buflen = 4096;
    let len = 0;
  ...
  LNSocket.prototype.make_ping_msg = function _lnsocket_make_ping_msg(
    num_pong_bytes = 1,
    ignored_bytes = 1
  ) {
    const buflen = 32;
